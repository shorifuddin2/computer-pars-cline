...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li>{user ? <button className="btn btn-ghost ml-28 " onClick={logout} >Sign Out</button> : <Link to="/login">Login</Link>}</li>
    </>
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost normal-case text-xl mr-5">Computer Parts</a>
            </div>
