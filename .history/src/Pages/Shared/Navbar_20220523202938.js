...
import computer from '../../assets/images/parts-icon'
...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li>{user ? <button className="btn btn-ghost ml-20 mr-0" onClick={logout} >Sign Out</button> : <Link to="/login">Login</Link>}</li>
    </>
    return (
