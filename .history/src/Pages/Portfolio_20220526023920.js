    ...
    return (
        <div class=" card lg:card-side  bg-orange-300 shadow-xl">
            ...
            <div class="card-body">
                ...
                <p className='w-80 text-1xl'>I'm Proportional Full Stack Web Developer.My profession is heard worked coding.2022 year Full Stack Project in the website bootstrap,tailwind, react bootstrap, es6, react router, firebase, mongodb, node js, heroku,express js. etc my product building very awesome actartiv locking for amain </p>
                <h3>My Address</h3>
