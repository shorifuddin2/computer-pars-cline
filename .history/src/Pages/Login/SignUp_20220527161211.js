...
const [token ]= use useToken()
    ...
    if (error || gError || updateError) {
        signInError = <p classNameName='text-red-500'><small>{error?.message || gError?.message || updateError?.message}</small></p>
    }
        ...
        <div classNameName='flex h-screen justify-center items-center'>
            <div classNameName="card w-96 bg-base-100 shadow-xl">
                <div classNameName="card-body">
                    <h2 classNameName="text-center text-2xl font-bold">Sign Up</h2>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div classNameName="form-control w-full max-w-xs">
                            ...
                            />
                            <label classNameName="label">
                                {errors.name?.type === 'required' && <span classNameName="label-text-alt text-red-500">{errors.name.message}</span>}
                            </label>
                        </div>
                        ...
                        {signInError}
                        <input classNameName='btn w-full max-w-xs text-white' type="submit" value="Sign Up" />
                    </form>
                    <p><small>Already have an account? <Link classNameName='text-primary' to="/login">Please login</Link></small></p>
