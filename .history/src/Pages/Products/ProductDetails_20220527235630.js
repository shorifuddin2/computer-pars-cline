            ...
            <div class="card w-96 bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form onSubmit={handleSubmit} className='w'>
                                    ...
                                    <div className="mb-6">
                                        <input type="text" onBlur={} name='orderQuantity' id="text" className="uppercase shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-400  focus:border-teal-400  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-400  dark:focus:border-teal-400  dark:shadow-sm-light" placeholder='Minimum Order' required />
                                    </div>
                                    <div className="mb-6">
