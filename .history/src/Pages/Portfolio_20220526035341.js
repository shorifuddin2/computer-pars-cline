    ...
    return (
        <div>
            <div class=" card lg:card-side  bg-orange-300 shadow-xl">
                ...
                <div class="card-body">
                    <h2 class="card-title text-primary text-4xl font-bo">This is Shorif Uddin</h2>
            ...
            <div className='grid grid-cols-3 gap-8 card bg-orange-200 shadow-2xl p-5'>
                <div>
            <h1 className='text-primary text-3xl font-bold text-center'>This is My Best website</h1>
