...
const Portfolio = () => {
    return (
        <div>
            ...
            <h1 className='text-primary text-2xl text-bold'>This is My Best website</h1>
                ...
                <div class="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions justify-end">
                            <div >
                             <a href='' target={_blnk} class="badge badge-outline">Cline Github</a>
                             <a href='' target={_blnk} class="badge badge-outline">Server Github</a>
                             <a href='' target={_blnk} class="badge badge-outline">Live website</a>
                             </div>
                        </div>
                    </div>
                </div>
