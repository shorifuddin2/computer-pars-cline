        ...
        <div>
            ...
            <section className='flex'>
                ...
                <div className='mx-20 p-20'>
                        ...
                        <div className='flex'>
                        <a href='' target='_blank'><img className='w-8 m-3' src={Facebook}/></a>
                        <a href='' target='_blank'><img className='w-8 m-3' src={Github}/></a>
                        <a href='' target='_blank'><img className='w-8 m-3' src={Linkedin}/></a>
                        <a href='' target='_blank'><img className='w-8 m-3' src={Email}/></a>
                        </div>
                </div>
            </section>
